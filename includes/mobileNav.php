      ...
      <ul class="mobileDropDownContainer">
        ...
        <li class="mobileDropToggle">
          ...
          <div class="mobileDropBox">
            <label for="seoPackagesByRegion">SEO Packages By Region
              <a href="product-category/seo-package-by-region"><i class="fa fa-arrow-circle-right"
          ...
          <div class="mobileDropBox">
            <label for="seoPackagesByLanguage">SEO Packages By Language
              <a href="product-category/seo-packages-by-language"><i class="fa fa-arrow-circle-right"
                  aria-hidden="true"></i></a>
            </label>
        ...
        <li class="mobileDropToggle">
          <label for="podcast">
            ...
            <a href="seo-packages-by-industies"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
          </label>
