...
<div class="row recentBlogsSection mt-2">
    ...
    <h1 class="titleBanner col-12 m-0 mw-100">Recent Blogs</h1>

    <?php foreach ($recentBlogs as $data): ?>
        <div class="col-md-4 col-sm-6  my-2">
            <div class="blogCommonCard">
                <a href="/blog/<?php echo $data['url'] ?>" class="imgBox">
                    <img src="./img/<?php echo $data['img'] ?>" alt="blog image">
                </a>
                <div class="contentBox">
                    <h4 class="my-2 text-center text-capitalize"><a href="/blog/<?php echo $data['url'] ?>"><?php echo $data['title'] ?></a></h4>
