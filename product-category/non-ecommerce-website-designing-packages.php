...
<head>
    ...
    <title>non-ecommerce website designing & development packages</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "non-ecommerce website designing & development packages";
...
<body>
    ...
    $AllProducts = [
        [
            "img" => "webdevelopment/nonecommerce/portfoliowebsite.png",
