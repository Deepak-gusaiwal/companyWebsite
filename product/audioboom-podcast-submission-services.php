...
<head>
    ...
    <title>audioboom-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "audioboom Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>AudioBoom PLC is an on-demand audio and podcasting distribution platform. AudioBoom offers business-to-business services to the radio, media and podcast industries</p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/audioboom.png" alt="audioboom.png">
            </div>
        </div>
    </div>
