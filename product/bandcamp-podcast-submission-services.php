...
<head>
    ...
    <title>Bandcamp-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "Bandcamp Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>Bandcamp is an American online audio distribution platform founded in 2007 by Oddpost co-founder Ethan Diamond and programmers Shawn Grunberger, Joe Holt and Neal Tucker, with headquarters in Oakland, California, US. On March 2, 2022, Bandcamp was acquired by Epic Games.</p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/brandcamp.webp" alt="brandcamp.webp">
            </div>
        </div>
    </div>
