...
<body>
    ...
    <div class="contentHolderSection">
        ...
        <div class="content container p-2">
          <h2>Why Opting the Best Local SEO Package is Important?</h2>
          <p>Our Indian local SEO packages can help your business get more search visibility in your locally targeted areas. Whether you are a local shop owner or local service provider, our local SEO packages are for all and everyone from any business or industry can leverage the benefits of local SEO packages of India.</p>
        </div>

        <div class="content container p-2">
        <h2>How to Choose A Local SEO Package?</h2>
        <p>Choosing the right Local SEO Package for your business is not a rocket science. All you need is to find the keywords what you potential customers may be searching online by using keyword research tools or sometimes you can use your common sense to figure out what your customers are searching online in order to find local service providers like you.</p>
        <p>But, if it seems to hard for you to choose the right Local SEO Package works for you then you can ask our Local SEO Experts to perform the research for the same which is completely free of cost.</p>
        </div>
