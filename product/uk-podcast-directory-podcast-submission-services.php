...
<head>
    ...
    <title>uk-podcast-directory-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "uk podcast directory Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/uk-podcast-directory.webp" alt="uk-podcast-directory.webp">
            </div>
        </div>
    </div>
