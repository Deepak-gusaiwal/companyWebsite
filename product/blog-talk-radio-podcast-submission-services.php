...
<head>
    ...
    <title>blog-talk-radio-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "blog talk radio Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/blog-talk-radio.webp" alt="blog-talk-radio.webp">
            </div>
        </div>
    </div>
