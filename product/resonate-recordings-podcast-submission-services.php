...
<head>
    ...
    <title>resonate-recordings-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "resonate recordings Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/resonate-recordings.png" alt="resonate-recordings.png">
            </div>
        </div>
    </div>
