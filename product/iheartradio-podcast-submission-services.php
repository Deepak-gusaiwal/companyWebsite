...
<head>
    ...
    <title>iHeartradio-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "iHeartradio Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>The iHeartRadio Podcast Awards is a podcast awards show that celebrates podcasts heard throughout the year across iHeartMedia radio stations nationwide and on iHeartRadio,</p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/iheartradio.webp" alt="iheartradio.webp">
            </div>
        </div>
    </div>
