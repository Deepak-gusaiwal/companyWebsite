...
<head>
    ...
    <title>last fm-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "last fm Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>Last.fm streams your favorite music for free while offering great listening, watching, and sharing features. What sets Last.fm apart from other services is that it learns what you like by paying attention to your musical preferences.</p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/lastfm.webp" alt="lastfm.webp">
            </div>
        </div>
    </div>
