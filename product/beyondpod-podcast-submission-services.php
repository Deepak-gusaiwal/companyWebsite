...
<head>
    ...
    <title>beyondpod-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "beyondpod Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>A beautiful podcasting app built for power and control.</p>
                    <p>BeyondPod gives you access to thousands free audio and video shows from all over the world. </p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/beyondpod.webp" alt="beyondpod.webp">
            </div>
        </div>
    </div>
