...
<head>
    ...
    <title>podfollow-com-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "podfollow com Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/podfollow-com.png" alt="podfollow-com.png">
            </div>
        </div>
    </div>
