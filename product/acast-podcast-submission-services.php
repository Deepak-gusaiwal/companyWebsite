...
<head>
    ...
    <title>Acast-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "Acast Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>Acast is a Swedish-founded company that provides hosting, monetization and growth support for
                        podcasts, and podcast advertising solutions for brands and media agencies. </p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/acast.webp" alt="acast.webp">
            </div>
        </div>
    </div>
