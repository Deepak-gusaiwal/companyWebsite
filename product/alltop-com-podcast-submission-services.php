...
<head>
    ...
    <title>alltop-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "alltop Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>AllTop aggregates all of the top news and information in real time. Our editors have carefully crafted each topic with the best sources allowing you to see what's happening quickly and from trusted sources. </p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/allTop.webp" alt="allTop.webp">
            </div>
        </div>
    </div>
