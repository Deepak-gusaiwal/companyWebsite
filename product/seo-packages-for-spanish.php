...
<head>
    ...
    <title>SEO Packages for spanish Language</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "SEO Packages for spanish Language";
    $categoryTitle = "SEO Packages By Language";
    $categoryUrl = "/product-category/seo-packages-by-language.php";
    $isProductPage=true;
...
<body>
    ...
    <div class="contentHolderSection">
        <div class="content container p-2">
            ...
            <h2 class="fs-1 ">SEO Packages for spanish Language</h2>
