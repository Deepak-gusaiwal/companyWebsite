...
<head>
    ...
    <title>American-podcast-submissions</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "American Podcast submissions";
    ...
    <div class="row flex-md-row-reverse podcastContainer my-2">
        ...
        <div class="col-md-8 podcasteRight py-3">
            <div class="contentBox d-flex flex-column align-items-md-start align-items-center">
                ...
                <div class="descriptionSection">
                    <h3>Description</h3>
                    <p>The American English Podcast teaches the language and culture of the United States. Through common expressions, pronunciation tips and interesting cultural snippets or stories, I hope to keep this fun, useful and interesting!</p>
                </div>
        ...
        <div class="col-md-4  d-flex justify-content-center align-items-center mt-md-0 mt-3">
            <div class="podcastImgBox">
                <img src="../assets/img/podcast/amarican.webp" alt="amarican.webp">
            </div>
        </div>
    </div>
