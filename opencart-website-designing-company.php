...
<head>
    ...
    <title>opencart Website development</title>

    <!-- cssLinks -->
    <?php
    $pageTitle = "opencart Website development";
    ...
    $subCategoryUrl="/product-category/ecommerce-website-designing-development-packages.php";
    $isProductPage = false;
